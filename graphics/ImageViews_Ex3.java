...
public class ImageViews_Ex3 extends JFrame 
implements ActionListener{
	...
	public ImageViews_Ex3(String name) {
		setSize(600,400);
		this.name = name;
	...
	public void paint(Graphics g) {
		...
		case SHOW_HORIZONTAL:
			g.drawImage(img, iw, 0, 0, 300, //컨테이너 좌표
					220, 20, 420, 220, this); //이미지 좌표
			break;
		case SHOW_VERTICAL:
			g.drawImage(img, 0, ih, iw, 300, //컨테이너 좌표
					0, 0, iw, ih, this); //이미지 좌표
			break;
		case SHOW_ALL:
			g.drawImage(img, iw, 0, 0, 300, //컨테이너 좌표
