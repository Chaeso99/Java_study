	...
	public ChatClient2()
{
	...
	public void routine(String line) 
	{
		...
		{
			//data가 aaa;bbb;ccc;홍길동 형식으로 넘어올것임
			list.removeAll();//기존의 리스트 아이템 전부 삭제
			list.add(listTitle);//****대화자 명단**** 글자 넣음
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		{//send
			...
			if(!flag)//처음입력에만 실행, 아이디 입력
			{
				sendMessage(ChatProtocol2.ID+ChatProtocol2.MODE+str);
