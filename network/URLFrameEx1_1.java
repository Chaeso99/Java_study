...
public class URLFrameEx1_1 extends MFrame implements ActionListener {
	...
	{
		try {
			FileWriter fw = new FileWriter("network/"+file+".html");
			fw.write(content);
			fw.close();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void main(String[] args) {
		URLFrameEx1_1 ex = new URLFrameEx1_1();	
	}
}
